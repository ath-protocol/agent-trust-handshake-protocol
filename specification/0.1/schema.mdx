...
The canonical machine-readable schema is available as an [OpenAPI 3.1 YAML file](https://github.com/agenttrusthandshake/agent-trust-handshake-protocol/blob/main/spec/openapi.yaml).

{/* TODO: Update URL once repo is published */}
...
| `SESSION_NOT_FOUND` | 400 | OAuth session expired or invalid |
| `STATE_MISMATCH` | 400 | OAuth state parameter mismatch |
| `TOKEN_INVALID` | 401 | ATH access token invalid or expired |
