...
<Card title="ATH Gateway" icon="server" href="https://github.com/agenttrusthandshake/gateway">
...
<CardGroup cols={2}>
  ...
  <Card title="API Specification" icon="file-lines" href="/specification/0.1/server/registration">
