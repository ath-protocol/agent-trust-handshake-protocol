...
| :--- | :--- | ---: |
| <Icon icon="square-js" size={24} /> &nbsp; TypeScript | [agenttrusthandshake/typescript-sdk](https://github.com/agenttrusthandshake/typescript-sdk) | <Badge color="blue" shape="pill">Official</Badge> |
...
2. **HTTP client** — Calls to the [ATH API endpoints](/specification/0.1/server/registration)
3. **PKCE support** — The gateway handles PKCE server-side, but your SDK should handle the authorization flow

See the [API Specification](/specification/0.1/server/registration) for the complete endpoint reference.
