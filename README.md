...
sequenceDiagram
    ...
    Note over C,S: 步骤1: 身份宣告
    C->>S: 客户端DID + 支持版本 + 能力集
    Note over C,S: 步骤2: 身份回应
    S->>C: 服务端DID + 协商版本 + 能力集
...
| 易用性 | 集成复杂，需要大量开发工作 | 提供多语言SDK，5分钟完成集成 |
---
>>>>>>> 663f134fa5e37042b048484eecef95181f03f6bf
## 📄 开源协议
...
| 文件路径 | 内容说明 | 重要程度 |
|---------|----------|----------|
| 📄 `specification/0.1/client/handshake-flow.mdx` | **最核心的握手流程规范**，详细定义了从发起请求到完成握手的8步完整流程，包括每一步的报文格式、交互逻辑、错误处理等 | ⭐⭐⭐⭐⭐ |
