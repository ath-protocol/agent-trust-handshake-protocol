...
<CardGroup cols={2}>
  <Card title="连接真实提供商" icon="github" href="/docs/develop/build-gateway">
    使用 GitHub、Google 或任何 OAuth 提供商配置网关
  </Card>
  <Card title="构建你自己的代理" icon="robot" href="/docs/develop/build-agent">
    在你自己的代理中使用 ATH 客户端 SDK
  </Card>
  <Card title="了解架构" icon="sitemap" href="/docs/learn/architecture">
    了解网关模式与原生模式
  </Card>
  <Card title="阅读规范" icon="file-lines" href="/specification/0.1">
    深入了解完整的协议规范
  </Card>
</CardGroup>
